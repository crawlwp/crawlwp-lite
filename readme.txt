...
Complete WordPress SEO: meta titles, schema, redirects and sitemaps, plus instant indexing on Google, Bing, Yandex and more.
...
1. The SEO metabox: search title, meta description and a live Google preview measured in pixels.
2. Title & Meta templates for the homepage, every post type, taxonomy and archive.
3. Redirect manager: 301, 302 and 410 rules with regex matching and hit counts.
4. Import SEO data from Yoast SEO, Rank Math, All in One SEO, SEOPress, The SEO Framework and Slim SEO.
5. Site Information: organization or person schema, logo, Local SEO and social profiles.
6. Bulk editor: fix SEO titles and meta descriptions across many posts from one table.
7. Links tab: suggested internal links, outbound links and posts already linking here.
...
* Added the SEO metabox with General, Analysis, Social, Schema, Links, Advanced and Insights tabs.
* Added JSON-LD schema graph: organisation or person representation, logo, sitelinks search box, sameAs profiles, article markup and BreadcrumbList.
* Added LocalBusiness schema with NAP details and opening hours.
* Added breadcrumbs with the [crawlwp_breadcrumbs] shortcode.
* Added Open Graph and X card output with share previews and a fallback image.
* Added a redirect manager with 301, 302 and 410 rules, regex matching and hit counts.
* Added automatic 301 redirects on permalink change.
* Added a 404 monitor.
* Added a robots.txt editor pre-filled with the site's current output.
* Premium: Added a Google News sitemap feed.
* Premium: Added a video sitemap.
* Premium: Added an HTML sitemap.
* Premium: Added multilingual sitemaps with WPML, Polylang and TranslatePress integrations.
* Added llms.txt support.
* Added RSS feed attribution with {{ postlink }} and {{ bloglink }}.
* Premium: Added internal link automation with keyword rules.
* Added Image SEO: auto-fill missing alt text.
* Added a bulk editor for SEO titles and meta descriptions.
* Added import from Yoast SEO, Rank Math, All in One SEO, SEOPress, The SEO Framework and Slim SEO, including redirects.
